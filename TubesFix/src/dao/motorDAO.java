...
public class motorDAO {
    ...
    public void insertCustomer(Kendaraan_Motor k) {
        ...
        String sql = "INSERT INTO motor(id_Kendaraan, jenis_Helm, jenis_Stang, jenis, nama_Kendaraan, platNo, merk, cc, tarif)" // bakal dicek dulu
                + "VALUES ('" +k.getId_Kendaraan()+ "', '" + k.getJenis_Helm()+ "','" + k.getJenis_Stang()+ "', '"
                + k.getJenis() + "', '" + k.getNama_Kendaraan() + "', '" + k.getPlatNo() + "', '" + k.getMerk() + 
                "', '" + k.getC"')";
